...
function initMap(road) {
  ...
  // map.data.loadGeoJson('/sampled_patching_IS.json', null, function (features) {
  //   console.log(markers);
  ...
  // var  markers=[];
  //   // var patching = feature.getProperty("color");
  //   // if (patching ===
  // var marker = new google.maps.Marker({
  //   position: feature.getGeometry(0),
  //   color:feature.getProperty('color'),
  //   map:map
  // });
  // markers.push(marker)

  // console.log(markers.color);
...
//   map.data.loadGeoJson('/test_IS.json', null, function (features) {
...
// });
  ...
  //   // console.log(markers);
  //   var markerCluster = new markerClusterer.MarkerClusterer({ map, markers });
  //   markerCluster(map, markers,{imagePath: 'https://cdn.rawgit.com/googlemaps/js-marker-clusterer/gh-pages/images/m' });
  ...
  map.data.loadGeoJson('/test_IS.json', null, function (features) {
    ...
    var markers = features.filter(function(feature) { return feature.getProperty('color') === "green" }).map(function (feature) {
        var g = feature.getGeometry();
        var marker = new google.maps.Marker({
        position: g.get(0),
        icon: icons["icon_green"],
        map:map 
        });
        return marker;
      });
      console.log("loading green markers");
    const greenCluster = new markerClusterer.MarkerClusterer({ map, markers,  imagePath: 'https://cdn.rawgit.com/googlemaps/js-marker-clusterer/gh-pages/images/m' });

    var markers = features.filter(function(feature) { return feature.getProperty('color') === "red" }).map(function (feature) {
      var g = feature.getGeometry();
      var marker = new google.maps.Marker({
      position: g.get(0),
      icon: icons["icon_red"],
      ...
      console.log("loading red markers");

    const redCluster = new markerClusterer.MarkerClusterer({ map, markers,  imagePath: 'https://cdn.rawgit.com/googlemaps/js-marker-clusterer/gh-pages/images/m' });

    var markers = features.filter(function(feature) { return feature.getProperty('color') === "yellow" }).map(function (feature) {
      var g = feature.getGeometry();
      var marker = new google.maps.Marker({
      position: g.get(0),
      icon: icons["icon_yellow"],
      map:map 
      });
      return marker;
    });
      console.log("loading yellow markers");
    const yellowCluster = new markerClusterer.MarkerClusterer({ map, markers,  imagePath: 'https://cdn.rawgit.com/googlemaps/js-marker-clusterer/gh-pages/images/m' });
